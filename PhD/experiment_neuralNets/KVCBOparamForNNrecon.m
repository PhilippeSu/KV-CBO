function param = KVCBOparamForNNrecon(d)
...
stopCond.nT = 200;    % maximum number of iterations
stopCond.method = 5;   % other stopping conditions are not implemented for multiple consensus points
