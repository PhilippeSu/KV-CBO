function param = paramForPhaseRetrieval(d,varargin)
...
param.initData = initialData(d,varargin{:});
...
function initData = initialData(d,varargin)
...
switch initData.method
    ...
    case 2
        ...
        initData.meanDir = varargin{1};
        initData.k = varargin{2}; 
    case 3
