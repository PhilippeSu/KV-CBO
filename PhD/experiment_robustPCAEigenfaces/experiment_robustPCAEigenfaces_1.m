...
%% Eigenfaces (no outliers, p = 2)

p = 2;

s = '10KUSAdult_Faces_0outliers.txt';
...
[U,~,~] = svd(X);
postProcess(U(:,1),pixely,pixelx,'Eigenface_SVD_1.png')
postProcess(-U(:,1),pixely,pixelx,'Eigenface_SVD_2.png')
...
% 
% postProcess(Va,pixely,pixelx,'Eigenface_KVCBO_1.png')
% postProcess(-Va,pixely,pixelx,'Eigenface_KVCBO_2.png')
...
if and(exist('fms.m','file'), exist('calc_sdist.m','file'))
    ...
    postProcess(L,pixely,pixelx,'Eigenface_FMS_1.png')
    postProcess(-L,pixely,pixelx,'Eigenface_FMS_2.png')
...
if isempty(which('spherefactory'))
    ...
    postProcess(x,pixely,pixelx,'Eigenface_GD_1.png')
    postProcess(-x,pixely,pixelx,'Eigenface_GD_2.png')
