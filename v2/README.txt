...
References
---------
Consensus-Based Optimization on Hypersurfaces: Well-Posedness and Mean-Field Limit, Mathematical Models and Methods in Applied Sciences, 30 (2020), pp. 2725–2751,

Consensus-Based Optimization on the Sphere: Convergence to Global Minimizers and Machine Learning, 2021

Anisotropic Diffusion in consensus-based optimization on the sphere, 2021
...
For the readers convenience we have included some test files:

1. Add path to MATLAB by executing import_kvcbo.m
